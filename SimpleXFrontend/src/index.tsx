...
import './index.css';
import { App } from './App';
import { DispatcherSession, GatewayRequest, Platform, Result } from '@uniscale-sdk/ActorCharacter-SimpleX';
...
import { Patterns as AccountPatterns } from '@uniscale-sdk/ActorCharacter-SimpleX/sdk/WherebyDemo/Account';
import { Patterns as StreamsPatterns } from '@uniscale-sdk/ActorCharacter-SimpleX/sdk/WherebyDemo/Streams';
...
const initializeApp = async (): Promise<DispatcherSession> => {
  const session = await Platform.builder()
    .withInterceptors(i => {
      ...
      // If they are commented out the feature calls will be sent to the service through
      // the url below
